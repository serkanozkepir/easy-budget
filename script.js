function calcSalary() {
  ...
  let net = brut * 0.78;
  document.getElementById("salaryResult").innerText = "Salaire net estimé : " + net.toFixed(2) + " €";
}
...
function calcInterest() {
  ...
  document.getElementById("interestResult").innerText = "Montant final : " + result.toFixed(2) + " €";
}
...
function calcBudget() {
  ...
  document.getElementById("budgetResult").innerText = "Solde : " + balance.toFixed(2) + " €";
}
...
function calcSavingsGoal() {
  ...
  document.getElementById("savingsResult").innerText = "Épargne totale cumulée : " + totalSaved.toFixed(2) + " €";
}
